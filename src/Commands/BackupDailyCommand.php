...
class BackupDailyCommand extends BaseCommand
{
    /** @var string */
    protected $signature = 'backupDaily:run {--filename=} {--only-db} {--db-name=*} {--only-files} {--only-to-disk=} {--disable-notifications} {--timeout=}';

    /** @var string */
    protected $description = 'Run the daily backup.';

    public function handle()
    {
        consoleOutput()->comment('Starting daily backup...');
        ...
        try {
            ...
            consoleOutput()->comment('Daily Backup completed!');
        } catch (Exception $exception) {
            consoleOutput()->error("Daily Backup failed because: {$exception->getMessage()}.");
